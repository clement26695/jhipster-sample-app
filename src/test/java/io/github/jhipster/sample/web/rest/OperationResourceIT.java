...
public class OperationResourceIT {
    ...
    public void setup() {
        ...
        this.restOperationMockMvc = MockMvcBuilders.standaloneSetup(
            operationResource
        )
    ...
    */
    ...
    public void getOperation() throws Exception {
        ...
        restOperationMockMvc.perform(
            ...
            .andExpect(
                jsonPath("$.description").value(DEFAULT_DESCRIPTION.toString())
            )
    ...
    public void updateOperation() throws Exception {
        ...
        Operation updatedOperation = operationRepository.findById(
            operation.getId()
        )
            .get();
